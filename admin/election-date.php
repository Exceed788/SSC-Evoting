                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="text" id="election_name"  name="election_name" required class="form-control">
                                <label>Election Date</label>
                                <input type="date" id="election_date"  min="<?php echo date('Y-m-d'); ?>" name="election_date" required class="form-control">
                            </div>
                        </div>
                    </div>
            </div>
  ...
  <script>
        electionIdForm.onsubmit = (e) => {
            ...
            $.ajax({
                ...
                method:"GET",
                data:{election_id:election_id.value, election_name: election_name.value, election_date:election_date.value},
                success:(ee)=>{
                    if(ee.trim() == 'success') {
                        alertService.alert({
                        response:'success',
        ...
        function getElection(election_object) {
            ...
            election_name.value = election_object.election_name;
