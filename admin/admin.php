  ...
  <div class="container-fluid mt-2"> 
    <div class="row">
      <div class=" col-sm-12 col-md-9 col-lg-9 col-xl-9">
        <h1 class=" text-sm-center text-xs-center text-md-left text-lg-left text-xl-left">Admin
        
        </h1>
      </div>
      <div class="col-sm-12 col-md-2 col-lg-2 col-xl-2" style="margin-left: 90px;">
    ...
    <?php    
            ...
            <input class="btn btn-danger text-white" type="submit" style= "margin-bottom: 5px; float:right;" disabled="true" name="resetCode" value="Generate Voting Codes"/>
            </form>';

            else
            echo '<form action="../process/reset-voting-code.php" method="POST">
            <input class="btn btn-danger text-white" style="margin-bottom: 5px; float:right;" type="submit"  name="resetCode" value="Generate Voting Codes"/>
            </form>';
                        ...
                        <div class="col-lg-6 col-md-6 col-xl-6 account">
                            <div class="form-group">
                                ...
                                <input type="password" name="password" class="form-control" id="password" placeholder="Input password" required>
                                 <input style="margin-top: 5px;" type="checkbox" onclick="pass()">Show Password
                            </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-xl-6 account">
                            <div class="form-group">
                                ...
                                <input type="password" name="retypePassword" class="form-control" id="retypePassword" placeholder="Input Retype Password" required>
                                 <input style="margin-top: 5px;" type="checkbox" onclick="retype()">Show Password
                            </div>
                        </div>
