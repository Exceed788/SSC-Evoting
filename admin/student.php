    ...
    <div class="row">
      ...
      <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
        <div class='d-flex flex-row w-100 justify-content-end'>
            ...
            <a class="btn btn-success" href="print.php" style="margin-right: -7px;" target="_blank" >Print Codes</a>
        </div>
        <script>
            function CSVReader() {
                      ...
                      <input type="hidden" class="form-control" name="id" id="id">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <img id="currentImage" name="currentImage" style="width:150px; height:200px;" src="" > 
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-xl-6">
                            <div class="form-group">
                                ...
                                <input maxlength="7" class="form-control" name="studentID" id="studentID" placeholder="Input Student ID" required>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-xl-6">
                            <div class="form-group">
...
<script type="text/javascript">
        ...
        $("#studentForm").on("submit", function(e){
            ...
            $.ajax({
                ...
                success: function(e){
                    ...
                    const message = e.toLowerCase() == 'success' ? 'Successfully Deleted!' : 'Failed to add!';
    ...
    function getStudent(id){
        ...
        $.ajax({
            ...
            success: function(e){ 
                ...
                $("#currentImage").attr("src", "http://localhost/dynamic/imgs/" + response['image']);
    ...
    function deleteStudent(id){
        deleteService.request({id:id,method:'post',url:'../process/StudentRoutes.php',isset:'deleteId',complete:(e)=>{ 
           const message = e.toLowerCase() == ' success' ? 'Successfully deleted!' : 'Successfully deleted!'; 
           alert(e);
           alertService.alert({response:e,message:message});
